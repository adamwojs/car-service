...
class TestimonialController extends Controller {
     ...
     *
     * @Route("/", name="admin_testimonial_create")
     * @Method("POST")
    ...
    public function createAction(Request $request) {
        ...
        if ($form->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_testimonial_show', array('id' => $entity->getId())));
        }
    ...
    private function createCreateForm(Testimonial $entity) {
        $form = $this->createForm(new TestimonialType(), $entity, array(
            'action' => $this->generateUrl('admin_testimonial_create'),
            'method' => 'POST',
        ));
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('CarServiceAppBundle:Testimonial')->find($id);
    ...
    private function createEditForm(Testimonial $entity) {
        $form = $this->createForm(new TestimonialType(), $entity, array(
            'action' => $this->generateUrl('admin_testimonial_update', array('id' => $entity->getId())),
            'method' => 'PUT',
        ));
     ...
     *
     * @Route("/{id}", name="admin_testimonial_update")
     * @Method("PUT")
     * @Template("CarServiceAppBundle:Testimonial:edit.html.twig")
     */
    public function updateAction(Request $request, $id) {
        ...
        if ($editForm->isValid()) {
            ...
            return $this->redirect($this->generateUrl('admin_testimonial_edit', array('id' => $id)));
        }
    ...
    public function deleteAction(Request $request, $id) {
        ...
        return $this->redirect($this->generateUrl('admin_testimonial'));
    }
    ...
    private function createDeleteForm($id) {
        return $this->createFormBuilder()
            ->setAction($this->generateUrl('admin_testimonial_delete', array('id' => $id)))
            ->setMethod('DELETE')
