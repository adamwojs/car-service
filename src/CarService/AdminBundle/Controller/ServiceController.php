...
use CarService\AppBundle\Entity\Service;
use CarService\AppBundle\Form\ServiceType;
...
class ServiceController extends Controller {
    ...
    public function indexAction() {
        ...
        $entities = $em->getRepository('CarServiceAppBundle:Service')->findAll();
     ...
     * @Method("POST")
     * @Template("CarServiceAppBundle:Service:new.html.twig")
     */
    ...
    public function showAction($id) {
        ...
        $entity = $em->getRepository('CarServiceAppBundle:Service')->find($id);
     ...
     * @Method("PUT")
     * @Template("CarServiceAppBundle:Service:edit.html.twig")
     */
